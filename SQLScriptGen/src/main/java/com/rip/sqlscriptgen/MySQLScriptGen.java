...
public class MySQLScriptGen implements DatabasePulgginInterface {
    ...
    public MySQLScriptGen() {
        dataTypes.put("short_string", "VARCHAR(10)");
        ...
        dataTypes.put("date_without_tz", "DATETIME");
        dataTypes.put("date", "DATETIME");
        dataTypes.put("time", "DATETIME");
        dataTypes.put("timestamp", "TIMESTAMP");
        dataTypes.put("small_blob", "BLOB");
        dataTypes.put("medium_blob", "MEDIUMBLOB");
        dataTypes.put("large_blob", "LONGBLOB");
        dataTypes.put("xml", "LONGTEXT");
        dataTypes.put("boolean", "TINYINT");
